...
Movie.remove({title:'jhonwick4'}).then(d=>console.log(d))
Movie.findOneAndDelete({title:'jhonwick3'}).then(d=>console.log(d))
Movie.deleteMany({title:{$in:['jhonwick','jhonwick2']}})
